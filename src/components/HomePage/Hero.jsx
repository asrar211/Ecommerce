...
const Hero = () => {
  return (
    <div className='mt-5'>
      ...
      <div className='max-[900px]:pb-10 h-[775px] max-[1400px]:h-[520px] z-10 text-white flex text-center flex-col justify-center items-center'>
        <p className='junge italic text-xl drop-shadow-lg my-5'>Fashion</p>
          ...
          <button className='bg-red-600 text-white font-semibold py-5 px-10 mt-10 max-[1400px]:px-6 max-[1400px]:py-4 '>Shop Now</button>
      </div>
    </div>
  )
}
